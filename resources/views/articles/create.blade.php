            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                   <form action="{{route('articles.store')}}" method="post">
                    @csrf
                    <div>
                        <label for="" class="text-lg font-midium">Title</label>
                        <div class="my-3">
                            <input value="{{ old('title')}}" name="title" placeholder="Enter Tatle" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                            @error('title')
                        ...
                        <div class="my-3">
                            <textarea name="text"  placeholder="Enter Content" id="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg" cols="30" rows="10">{{ old('text')}}</textarea>
                        </div>
