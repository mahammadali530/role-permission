           ...
           <table class="w-full">
            ...
            <tbody class="bg-white">
                ...
                <tr class="border-b">
                    ...
                    <button class="bg-slate-700 text-sm rounded-md text-white px-3 py-2 hover:bg-slate-600 editbtn" data-id="{{ $permission->id }}">Edit</button>
                    @endcan
                    @can('delete permissions')
                    <a href="{{ route('delete.artical', ['id' => $permission]) }}" onclick="return confirm('Are you sure?');" class="bg-red-600 text-sm rounded-md text-white px-3 py-2 hover:bg-red-500">Delete</a>
                    @endcan
                   </div>
                    </td>
                </tr>
