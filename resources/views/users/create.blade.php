            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                   <form action="{{route('users.store')}}" method="post">
                    @csrf
                    <div>
                        <label for="" class="text-lg font-midium">Name</label>
                        <div class="my-3">
                        ...
                        <label for="" class="text-lg font-midium">Email</label>
                        <div class="my-3">
                            <input value="{{ old('email')}}" name="email" placeholder="Enter Email" type="email" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                            @error('email')
                            <p class="text-red-400 font-midium">{{$message}}</p>
                            @enderror
                            </div>
                            <label for="" class="text-lg font-midium">Password</label>
                        <div class="my-3">
                        ...
                        <label for="" class="text-lg font-midium">Confirm Password</label>
                        <div class="my-3">
                            <input value="{{ old('confirm_password')}}" name="confirm_password" placeholder="Enter confirm password" type="password" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
