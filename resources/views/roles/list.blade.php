           ...
           <table class="w-full">
            ...
            <tbody class="bg-white">
                ...
                <tr class="border-b">
                    ...
                    @endcan
                    @can('delete roles')
                    <a href="{{ route('delete.roles', ['id' => $role]) }}" onclick="return confirm('Are you sure?');" class="bg-red-600 text-sm rounded-md text-white px-3 py-2 hover:bg-red-500">Delete</a>
                  @endcan
                     </div>
                    </td>
                </tr>
